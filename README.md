...
- [x] [Harvard CS50 - Asymptotic Notation (video)](https://www.youtube.com/watch?v=iOq5kSKqeR4) `5.1.24`
...
- ### Queue
  ...
  - [x] Implement using linked-list, with tail pointer:
    ...
    - empty()
  - [x] Implement using a fixed-sized array: (implimented a ring buffer)
